...
class OranLmNr2NrDistanceHandover : public OranLm
{
  ...
  public:
    /**
     * Gets the TypeId of the OranLmNr2NrDistanceHandover class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranLmNr2NrDistanceHandover class.
     */
    OranLmNr2NrDistanceHandover();
    /**
     * Destructor of the OranLmNr2NrDistanceHandover class.
     */
  ...
  private:
     ...
     */
    std::vector<OranLmNr2NrDistanceHandover::UeInfo> GetUeInfos(
