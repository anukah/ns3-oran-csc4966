 ...
 * @ingroup oran
 *
 * A Reporter that captures the NR UE DL Control SINR of the node.
 */
class OranReporterNrUeSinr : public OranReporter
{
  public:
    /**
     * Get the TypeId of the OranReporterNrUeSinr class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReporterNrUeSinr class.
     */
    OranReporterNrUeSinr();
    /**
     * Destructor of the OranReporterNrUeSinr class.
     */
    ~OranReporterNrUeSinr() override;
    /**
     * Reports the DL CTRL SINR for an NR UE.
     * Callback signature matches NrUePhy::DlCtrlSinrTracedCallback.
     *
     ...
     */
    void ReportSinr(uint16_t cellId,
                    uint16_t rnti,
                    double sinr,
                    uint16_t bwpId);
  ...
  protected:
    /**
     * Returns the generated OranReportNrUeSinr reports.
     *
