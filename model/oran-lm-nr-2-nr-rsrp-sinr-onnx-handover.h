...
#ifndef ORAN_LM_NR_2_NR_RSRP_SINR_ONNX_HANDOVER_H
#define ORAN_LM_NR_2_NR_RSRP_SINR_ONNX_HANDOVER_H
 ...
 * an NR cell to another based on an ONNX ML model using RSRP and SINR
 * measurements as input features.
 *
 * The model takes two features per UE: the serving-cell SINR (dB) and
 * the absolute RSRP difference between serving and best-neighbor cells.
 * It outputs a binary classification: 1 = handover recommended.
 */
class OranLmNr2NrRsrpSinrOnnxHandover : public OranLm
{
  protected:
    struct UeInfo
    {
  ...
  public:
    ...
    ~OranLmNr2NrRsrpSinrOnnxHandover() override;
...
}; // class OranLmNr2NrRsrpSinrOnnxHandover

} // namespace ns3

#endif /* ORAN_LM_NR_2_NR_RSRP_SINR_ONNX_HANDOVER_H */
