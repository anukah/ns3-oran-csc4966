 ...
 * @ingroup oran
 *
 * Report with the DL Control SINR measurement of an NR UE for the serving cell.
 */
class OranReportNrUeSinr : public OranReport
{
  public:
    /**
     * Get the TypeId of the OranReportNrUeSinr class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranReportNrUeSinr class.
     */
    OranReportNrUeSinr();
    /**
     * Destructor of the OranReportNrUeSinr class.
     */
    ...
    /**
     * Gets the bandwidth part ID.
     *
     * @return The bandwidth part ID.
     */
